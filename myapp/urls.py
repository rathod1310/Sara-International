...
urlpatterns = [
    ...
    path('products/pickles-chutney/', views.pickles_chutney, name='pickles_chutney'),
    path('products/ready-paste/', views.ready_paste, name='ready_paste'),
    ...
    path('products/agarbatti/', views.agarbatti, name='agarbatti'),
    path('products/dhoop-stick/', views.dhoop_stick, name='dhoop_stick'),
    path('products/makhana-chana-peanuts/', views.makhana_chana_peanuts, name='makhana_chana_peanuts'),
